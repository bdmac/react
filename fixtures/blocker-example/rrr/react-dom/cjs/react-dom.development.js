...
var UnknownException = 0;
var ErrorException = 1;
var SuspendException = 2;
var SuspendAndLoadingException = 3;
...
function createRootExpirationError(sourceFiber, renderExpirationTime) {
  try {
    ...
    return createCapturedValue(error, sourceFiber);
  }
}
...
var ReactFiberUnwindWork = function (hostContext, retryOnPromiseResolution, scheduleWork, isAlreadyFailedLegacyErrorBoundary, markTimeout) {
  ...
  function throwException(returnFiber, sourceFiber, value, renderIsExpired, remainingTimeMs, elapsedMs, renderStartTime, renderExpirationTime) {
    ...
    var typeOfException = value !== null && typeof value === 'object' && typeof value.then === 'function' ? SuspendAndLoadingException : // TODO: Because we currently only support thenables and errors, we
    // could change this to ErrorException, avoiding the need to traverse
    // the parent path twice.
    UnknownException;
      ...
      switch (workInProgress.tag) {
        ...
        case TimeoutComponent:
          switch (typeOfException) {
            ...
            case SuspendException:
              {
                var didExpire = workInProgress.memoizedState;
            ...
            case SuspendAndLoadingException:
              {
                ...
                if (current !== null && !isLoading && !renderIsExpired) {
                  ...
                  scheduleLoadingState(workInProgress, renderStartTime, renderExpirationTime);
...
var ReactFiberScheduler = function (config) {
  ...
  function renderRoot(root, expirationTime, isAsync) {
    if (!isAsync && expirationTime !== Sync) {
      // FIXME: temporary hack
      expirationTime = mostRecentCurrentTime;
    }

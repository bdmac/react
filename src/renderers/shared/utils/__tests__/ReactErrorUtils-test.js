...
describe('ReactErrorUtils', () => {
  ...
  function invokeGuardedCallbackTests(environment) {
    ...
    if (!__DEV__) {
      // jsdom doesn't these properly, but Chrome and Firefox should. Test this
      // with a fixture.
      it('catches null and undefined', () => {
        ReactErrorUtils.invokeGuardedCallback(
          null,
          function() {
            throw null;
        ...
        expect(ReactErrorUtils.hasCaughtError()).toBe(true);
        expect(ReactErrorUtils.clearCaughtError()).toBe(undefined);
      });
    }
